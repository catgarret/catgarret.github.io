(function () {
  ...
  const messages = {
    ko: {
      ...
      kinetoTitle: '이 효과가 마음에 드셨나요?',
      kinetoDescription: 'Kineto에서 픽셀 모자이크와 더 많은 웹 모션을 직접 조정하고, 코드를 바로 복사해 보세요.',
      kinetoCta: 'Kineto에서 더 보기',
    ...
    en: {
      ...
      kinetoTitle: 'Like this effect?',
      kinetoDescription: 'Explore pixel mosaic and more web motions in Kineto. Tune live, copy code, and ship.',
      kinetoCta: 'Explore Kineto',
    ...
    ja: {
      ...
      kinetoTitle: 'このエフェクトが気に入りましたか？',
      kinetoDescription: 'Kinetoでピクセルモザイクや多彩なWebモーションを調整し、コードをすぐにコピーできます。',
      kinetoCta: 'Kinetoでもっと見る',
    ...
    'zh-TW': {
      ...
      kinetoTitle: '喜歡這個效果嗎？',
      kinetoDescription: '在 Kineto 探索像素馬賽克與更多網頁動態效果。即時調整，直接複製程式碼。',
      kinetoCta: '探索 Kineto',
    ...
    th: {
      ...
      kinetoTitle: 'ชอบเอฟเฟกต์นี้ไหม?',
      kinetoDescription: 'สำรวจพิกเซลโมเสกและโมชั่นเว็บอีกมากมายใน Kineto ปรับแต่งสดแล้วคัดลอกโค้ดได้ทันที',
      kinetoCta: 'สำรวจ Kineto',
    ...
    'zh-CN': {
      ...
      kinetoTitle: '喜欢这个效果吗？',
      kinetoDescription: '在 Kineto 探索像素马赛克和更多网页动效。实时调节，直接复制代码。',
      kinetoCta: '探索 Kineto',
    ...
    'zh-Hant': {
      ...
      kinetoTitle: '喜歡這個效果嗎？',
      kinetoDescription: '在 Kineto 探索像素馬賽克及更多網頁動態效果。即時調整，直接複製程式碼。',
      kinetoCta: '探索 Kineto',
      status: '轉場 {duration} · 等待 {delay} · {stages} · 雜訊 {noise}',
      customStages: '自訂 {values}',
    ...
    ru: {
      ...
      kinetoTitle: 'Понравился эффект?',
      kinetoDescription: 'Попробуйте пиксельную мозаику и другие веб-эффекты в Kineto. Настройте и скопируйте готовый код.',
      kinetoCta: 'Открыть Kineto',
    ...
    it: {
      ...
      kinetoTitle: 'Ti piace questo effetto?',
      kinetoDescription: 'Scopri il mosaico pixel e altri effetti web in Kineto. Personalizzali e copia subito il codice.',
      kinetoCta: 'Esplora Kineto',
